            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td style="padding: 25px 0; text-align: center;">
                        <a style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #2F3133; text-decoration: none; text-shadow: 0 1px 0 white;" href="http://proveedores.app" target="_blank">
                            ...
                            <tr>
                                <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                    ...
                                    <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                        Desde el Jockey Club A.C. queremos darle la bienvenida al sistema de información para proveedores, desde donde podrá
                                        acceder a información relacionada al estatus de sus facturas pendientes y los pagos recibidos.
                                    </p>
                                    <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                        Si
                                    </p>
                                        ...
                                        <tr>
                                            <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif;">
                                                <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                                    Si tiene algún problema hacienco click en el botón "Restablecer Contraseña",
                        ...
                        <table style="width: auto; max-width: 570px; margin: 0 auto; padding: 0; text-align: center;" align="center" width="570" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; color: #AEAEAE; padding: 35px; text-align: center;">
                                    <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                        &copy; 2017
                                        <a style="color: #3869D4;" href="{{ url('/') }}" target="_blank">Proveedores Jockey Club A.C.</a>.
